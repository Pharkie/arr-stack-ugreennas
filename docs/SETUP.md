...
3. **Upstream DNS (optional):** Settings → DNS. Default uses Pi-hole's built-in resolver. Set upstream (1.1.1.1, 8.8.8.8) for faster lookups at the cost of sharing queries with that provider.
